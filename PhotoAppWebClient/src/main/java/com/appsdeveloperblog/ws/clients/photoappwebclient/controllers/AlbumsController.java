...
//	RestTemplate restTemplate;
	...
	public String getAlbum(Model model, @AuthenticationPrincipal OidcUser principal) {
		 ...
		 * 
		 * OidcIdToken idToken = principal.getIdToken(); String idTokenValue =
		 * idToken.getTokenValue(); System.out.println("idTokenValue = " +
		 * idTokenValue);
		 * 
		 * String url = "http://localhost:8082/albums"; HttpHeaders headers = new
		 * HttpHeaders(); headers.add("Authorization", "Bearer " + jwtAccessToken);
		 * 
